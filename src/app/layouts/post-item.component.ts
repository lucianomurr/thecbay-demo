...
@Component({
  ...
  template: `
    <article class="flex flex-col shadow my-4">
      <!-- Article Image -->
      <a
        [routerLink]="['/blog/', ArticleData.attributes.slug]"
        class="hover:opacity-75"
      >
        <img
          [ngSrc]="ArticleData.attributes.coverImage"
          width="1000"
          height="300"
        />
      </a>
      <div class="bg-white flex flex-col justify-start p-6">
        ...
        >
          ...
          <a
            ...
            >{{ ArticleData.attributes.author }}</a
          >, Published on April 25th, 2020
        </p>
        <a href="#" class="pb-6">{{ ArticleData.attributes.description }}</a>
        <a
          [routerLink]="['/blog/', ArticleData.attributes.slug]"
